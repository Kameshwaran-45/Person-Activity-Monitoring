...
class Tracker:
    ...
    def update(self, detections, classes, confidences, pose_list):
        ...
        for track_idx, detection_idx in matches:
            self.tracks[track_idx].update(
                detections[detection_idx], classes[detection_idx], confidences[detection_idx],pose_list,detection_idx)
